...
const UploadDropzone = () => {
  ...
  const { startUpload } = useUploadThing('pdfBasicAttachment');
      ...
      onDrop={async (acceptedFile) => {
        ...
        if (!res) {
          return toast({
            ...
            description: 'There was a problem with uploading your file',
          });
        }
        ...
        >
          <div className="flex items-center justify-center h-full w-full">
            <div className="flex flex-col items-center justify-center w-full h-full rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
              ...
              <label htmlFor="dropzone-file" className="sr-only">
                Upload a PDF file
              </label>
